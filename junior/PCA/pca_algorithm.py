...
class PCA:
    ...
    def fit(self, X: np.ndarray):
        ...
        # Получаем индексы собственных значений в порядке убывания
        sorted_indices = np.argsort(eigenvalues)[::-1]
        # Сортированные собственные значения
        sorted_eigenvalues = eigenvalues[sorted_indices]
        # Сортированные собственные векторы
        ...
        self.explained_variance_ratio_ = self.explained_variance_ / np.sum(sorted_eigenvalues)
